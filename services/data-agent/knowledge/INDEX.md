...
[domains]
  ...
  property-rent-overview — NSW rent mart — postcode-grained, no suburb; key columns.
  property-sales-overview — NSW property sales mart — table grain and the key columns to query.
